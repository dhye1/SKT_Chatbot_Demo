...
# # 이미지 파일 경로
# ANGER_IMAGE_PATH = "img/anger.png"
# EXCITED_IMAGE_PATH = "img/excited.png"
# FRUST_IMAGE_PATH = "img/frustrated.png"
# HAPPY_IMAGE_PATH = "img/happy.png"
# NEUTRAL_IMAGE_PATH = "img/neutral.png"
# SAD_IMAGE_PATH = "img/sadness.png"
...
#                     with open(wav_file_path, "rb") as audio_file:
#                         files = {'audio_file': audio_file}
#                         data = {'text': st.session_state.full_transcript}
#                         try:
#                             response = requests.post(FLASK_API_URL, files=files, data=data, timeout=30)
#                             if response.status_code == 200:
#                                 response_data = response.json()
...
#                                 symptom_weights_text = "\n".join([f'"{symptom.replace("phq_", "")}": {weight}' for symptom, weight in symptom_weights.items()])

#                                 st.session_state["final_message"] = (
#                                     f"Your current emotion is **'{emotion_prediction}'**.\n\n"
#                                     "Your depressive symptoms are as follows:\n"
#                                     f"{symptom_weights_text}"
#                                 )

#                                 st.session_state.messages.append({"role": "assistant", "content": st.session_state["final_message"]})

#                                 if emotion_prediction == "happy":
#                                     st.image(HAPPY_IMAGE_PATH, caption="Emotion: Happy")
#                                 elif emotion_prediction == "sadness":
#                                     st.image(SAD_IMAGE_PATH, caption="Emotion: Sadness")
#                                 elif emotion_prediction == "neutral":
#                                     st.image(NEUTRAL_IMAGE_PATH, caption="Emotion: Neutral")
#                                 elif emotion_prediction == "frustrated":
#                                     st.image(FRUST_IMAGE_PATH, caption="Emotion: Frustrated")
#                                 elif emotion_prediction == "excited":
#                                     st.image(EXCITED_IMAGE_PATH, caption="Emotion: Excited")
#                                 elif emotion_prediction == "anger":
#                                     st.image(ANGER_IMAGE_PATH, caption="Emotion: Anger")
...
#         vmin=0
#     )
#     plt.title("Depressive Symptom Weights")
#     st.pyplot(plt)
...
#     # 히트맵 출력
#     symptom_weights = st.session_state["depression_symptoms"]
#     # st.write("### Depressive Symptom Importance Heatmap")
#     plot_symptom_heatmap(symptom_weights)
